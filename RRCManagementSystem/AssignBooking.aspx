...
<div class="mt-4">
    <div class="d-flex justify-content-end align-items-center gap-2">
        <!-- Visible Button: Triggers SweetAlert -->
...
<!-- Hidden Field to store confirmation -->
<asp:HiddenField ID="hfConfirmAssign" runat="server" Value="false" />

<!-- Hidden Button: Triggers server-side logic -->
<asp:Button ID="btnHiddenAssign" runat="server"
    Style="display:none;"
...
<asp:Label ID="lblMessage" runat="server"
    Visible="false"
    CssClass="alert alert-info d-block mt-3 fw-semibold" />
        ...
        function confirmAssign() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    // ✅ Safely trigger the hidden ASP.NET button (triggers server-side logic)
