...
<asp:Content ID="HeadContent" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <style>
        ...
        .fixed-grid#wrap-gvMyBookings > table thead th:last-child, .fixed-grid#wrap-gvMyBookings > table tbody td:last-child{ min-width:140px; }
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainContent" runat="server">
                ...
                <div class="table-responsive fixed-grid" id="wrap-gvUpcoming">
                    <asp:GridView ID="gvUpcoming" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="OperationNumber" HeaderText="Visit" />
                            <asp:BoundField DataField="Status" HeaderText="Status" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-text">Your new preferred date/time will be sent for approval.</div>
                </div>
                <div class="modal-footer">
                 
                    <asp:Button ID="btnConfirmSchedule" runat="server" Text="Send Request" CssClass="btn btn-success"
    ...
    <script>
        ...
        function hideModal() { if (setScheduleBsModal) setScheduleBsModal.hide(); }
