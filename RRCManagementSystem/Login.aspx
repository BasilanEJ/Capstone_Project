...
<form id="form1" runat="server">
    ...
    <div class="login-container bg-white p-12 md:p-16 rounded-2xl shadow-2xl flex flex-col items-center text-center border border-gray-200 w-11/12 max-w-xl transition-transform hover:translate-y-[-5px]">
        ...
        <asp:Panel ID="pnlLogin" runat="server" DefaultButton="btnLogin" CssClass="w-full">
            <asp:TextBox ID="txtEmail" runat="server" CssClass="input block w-full px-4 py-3 rounded-lg border border-gray-300 text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent mb-5" placeholder="Email"
            ...
            <asp:Button ID="btnLogin" runat="server" CssClass="btn-login w-full py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-300" Text="Login"
        ...
        <asp:Label ID="lblMessage" runat="server" CssClass="message mt-4 text-sm text-red-500"></asp:Label>
    </div>
