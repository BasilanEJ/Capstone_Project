...
<div style="text-align:center; margin-bottom: 30px;">
    ...
    <asp:Button ID="btnExportPDF" runat="server" Text="Export All Reports to PDF" CssClass="btn-sales" OnClick="btnExportPDF_Click" />
</div>
...
<div class="tab-navigation">
    <asp:Button ID="btnTabUsers" runat="server" Text="User Accounts" CssClass="tab-btn" OnClick="btnTabUsers_Click" />
    <asp:Button ID="btnTabInquiries" runat="server" Text="Inquiries" CssClass="tab-btn" OnClick="btnTabInquiries_Click" />
    <asp:Button ID="btnTabClients" runat="server" Text="Clients" CssClass="tab-btn" OnClick="btnTabClients_Click" />
    <asp:Button ID="btnTabInventorySnapshots" runat="server" Text="Total Stocks Snapshots" CssClass="tab-btn" OnClick="btnTabInventorySnapshots_Click" />
    <asp:Button ID="btnTabInventory" runat="server" Text="Inventory Details" CssClass="tab-btn" OnClick="btnTabInventory_Click" />
    <asp:Button ID="btnTabEquipment" runat="server" Text="Equipment" CssClass="tab-btn" OnClick="btnTabEquipment_Click" />
    <asp:Button ID="btnTabSales" runat="server" Text="Sales" CssClass="tab-btn" OnClick="btnTabSales_Click" />
    <asp:Button ID="btnTabBookings" runat="server" Text="Bookings" CssClass="tab-btn" OnClick="btnTabBookings_Click" />
    <asp:Button ID="btnTabInspections" runat="server" Text="Inspections" CssClass="tab-btn" OnClick="btnTabInspections_Click" />
    <asp:Button ID="btnTabTeams" runat="server" Text="Team Reports" CssClass="tab-btn" OnClick="btnTabTeams_Click" />
</div>
...
<!-- 📬 Inquiries Panel -->
<asp:Panel ID="pnlInquiries" runat="server" Visible="false">
    <div class="section-header">
        <h3>📬 Inquiries</h3>
...
<asp:Panel ID="pnlInventorySnapshots" runat="server" Visible="false">
    <div class="section-header">
...
<!-- 🛠️ Equipment Panel -->
<asp:Panel ID="pnlEquipment" runat="server" Visible="false">
    <div class="section-header">
...
<!-- 🔍 Inspections Panel -->
<asp:Panel ID="pnlInspections" runat="server" Visible="false">
    <div class="section-header">
