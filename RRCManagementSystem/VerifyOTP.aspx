    ...
    <style>
        ...
        * {
        ...
        .input {
            ...
            font-family: 'Poppins', sans-serif;
            outline: none;
            /* Added for consistency with OTP style boxes */
            text-align: center; 
            letter-spacing: 5px; /* Use letter spacing for OTP visual effect */
        }
        ...
        .links-container {
            ...
            align-items: center;
            justify-content: center;
            /* Using space-between/around for two links */
            justify-content: space-around; 
            padding: 0 10px;
        }
        
        /* Adjusted Links container for two links to match style */
        .links-container.two-links {
             margin-top: 25px;
             width: 100%;
             display: flex;
             justify-content: space-around; 
...
<body onload="initScripts()">
    <form id="form1" runat="server">
        <div class="login-container">
            ...
            <div class="links-container two-links">
                <a href="ForgotPassword.aspx" class="link">
                    <i class="fa-solid fa-rotate-right" style="margin-right: 5px;"></i>Resend OTP
                </a>
