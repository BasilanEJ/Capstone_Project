...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <style>
        .container { padding: 30px; background-color: #f8f9fa; min-height: calc(100vh - 100px); }
        h3 { margin-bottom: 20px; color: #004085; }
        .filters { margin-bottom: 20px; }
        .filters input, .filters select { padding: 6px; margin-right: 10px; }
        .table { width: 100%; border-collapse: collapse; margin-top: 20px; }
        .table th, .table td { padding: 12px; text-align: center; border: 1px solid #dee2e6; }
