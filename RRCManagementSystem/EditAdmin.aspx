                ...
                <table class="table table-bordered" style="width:100%; border-collapse: collapse; text-align:left;">
                    <thead style="background-color:#f0f0f0;">
                        <tr>
                            ...
                            <th class="chkView">View <input type="checkbox" onclick="toggleAll(this, 'chkView')" /></th>
                            <th class="chkAdd">Add <input type="checkbox" onclick="toggleAll(this, 'chkAdd')" /></th>
                            <th class="chkEdit">Edit <input type="checkbox" onclick="toggleAll(this, 'chkEdit')" /></th>
                            <th class="chkDelete">Delete <input type="checkbox" onclick="toggleAll(this, 'chkDelete')" /></th>
                        </tr>
                    </thead>
                    <tbody>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td class="chkView text-center">
                        <asp:CheckBox ID="chkView" runat="server" Checked='<%# Eval("CanView") %>' />
                    </td>
                    <td class="chkAdd text-center">
                        <asp:CheckBox ID="chkAdd" runat="server" Checked='<%# Eval("CanAdd") %>' onclick="ensureView(this)" />
                    </td>
                    <td class="chkEdit text-center">
                        <asp:CheckBox ID="chkEdit" runat="server" Checked='<%# Eval("CanEdit") %>' onclick="ensureView(this)" />
                    </td>
                    <td class="chkDelete text-center">
                        <asp:CheckBox ID="chkDelete" runat="server" Checked='<%# Eval("CanDelete") %>' onclick="ensureView(this)" />
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
